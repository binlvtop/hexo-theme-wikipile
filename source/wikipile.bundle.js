...
function createMask() {
  var maskClassName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "page-mask";
  var $mask = $('.' + maskClassName);
...
module.exports = {
  ...
  function initArticleScroll() {
    ...
    var animate = 'scrollIn'; // get window params

    var wH = $(window).height(),
        wScrollTop = $(window).scrollTop(); // get offset top of elements
    ...
    obj.eq(0).addClass(animate); // check (is visible in window ? ) 

    function judgeScroll() {
      for (var j = 1; j < offsetTop.length; j++) {
    ...
    judgeScroll(); // update window params
...
exports.init = function () {
  var $tocSider = $('.toc-sidebar'),
      $tocTitle = $('.toc-title'),
      $tocList = $('.toc-list'); // 仅在post页启用脚本

  if (!$tocList[0]) return; // 当toc目录有内容的时候才显示toc容器

  if ($tocList[0].innerHTML.trim() !== '') {
    $tocSider.show();
  } else return; // 绑定点击 显示/隐藏 toc 功能
  ...
  initFixListener(); // toc目录根据阅读进度 跟随
...
function initFollow() {
  var $headers = $('.post-content h1,.post-content h2,.post-content h3,.post-content h4,.post-content h5,.post-content h6');
  $(window).scroll(function () {
...
var LazyLoad = function () {
  ...
  LazyLoad.prototype = {
    ...
    isNolazy: function isNolazy(image) {
...
// EXTERNAL MODULE: ./src/css/style.styl
var style = __webpack_require__(5);

// EXTERNAL MODULE: ./src/scripts/utils.js
...
function initActiveMenu() {
  var href = window.location.href,
      ...
      activeMenuItem = 'home';
  var pagesType = ['home', 'archives', 'categories', 'tags', 'about'];
  var _arr = pagesType;
  ...
  var item = $('#header-menu-'.concat(activeMenuItem));
...
function listenerScroll() {
  ...
  var resetBackToTop = function resetBackToTop() {
  ...
  init: function init() {
    if (!utils_default.a.isPc) {
      ...
      $toggle.click(function () {
        $mask = utils_default.a.createMask();
        showMenu();
        var _arr = [$mask, $menuSearch];
...
var showMenu = function showMenu() {
  var $icon = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : $('.mobile-toggle');
  var $mask = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : $('.page-mask');
  ...
  $('.container').removeClass('slide-left').addClass('slide-right');
...
var hideMenu = function hideMenu() {
  ...
  $('.container').removeClass('slide-right').addClass('slide-left');
  $('#footer').removeClass('slide-right').addClass('slide-left');
  $mask.remove();
};
// CONCATENATED MODULE: ./src/scripts/search.js
//----------
//search
//----------
...
/* harmony default export */ var search = ({
  init: function init() {
    ...
    //  触发搜索的DOM
    //
    search_search('/search.xml', 'search-input', 'search-result');
...
function opContainer() {
  ...
  var $msk = utils_default.a.createMask();
...
function search_search(path, search_id, content_id) {
  $.ajax({
    url: path,
    dataType: 'xml',
...
// EXTERNAL MODULE: ./src/scripts/toc.js
var toc = __webpack_require__(3);
var toc_default = /*#__PURE__*/__webpack_require__.n(toc);

// CONCATENATED MODULE: ./src/scripts/post.js
//------------------
//	post
//------------------
...
function initDonate() {
  ...
  var _arr2 = [$donate_wechat, $donate_alipay];
  ...
  var showDonateQR = function showDonateQR($icon) {
...
function initShare() {
  ...
  $share_btn.click(function () {
    var $mask = utils_default.a.createMask();
...
// EXTERNAL MODULE: ./src/css/_import/hover.styl
var hover = __webpack_require__(6);

// CONCATENATED MODULE: ./src/scripts/hover.js

/* harmony default export */ var scripts_hover = ({
  init: function init() {
    var $socials = $('.social a'),
...
// EXTERNAL MODULE: ./src/css/_import/gallery.styl
var gallery = __webpack_require__(7);

// CONCATENATED MODULE: ./src/scripts/gallery.js


/* harmony default export */ var scripts_gallery = ({
  init: function init() {
    // 开启Gallery的格式
    var galleryElements = $('.banner,.gallery,img');
...
Gallery.prototype = {
  init: function init() {
    ...
    if (utils_default.a.isPc) {
      var _loop = function _loop(i) {
        _this.elements[i].addEventListener('click', function () {
          _this.show(_this.elements[i]);
        });
      };
  ...
  show: function show(element) {
    ...
    if (element.height < 340 || element.width < 340 || element.height > height || element.width > width) return;
    ...
    if (src) {
      ...
      var bgr = element.style.backgroundImage,
          _src = bgr.substring(6, bgr.length - 2);
    ...
    gContainer.addEventListener('click', function () {
      _this2.destoryGallery();
    });
    document.getElementsByTagName('body')[0].appendChild(gContainer);
  },
  setStyle: function setStyle(elements, width, height, center) {
  ...
  destoryGallery: function destoryGallery() {
    var gContainer = document.getElementsByClassName(this.style.container)[0];
    document.getElementsByTagName('body')[0].removeChild(gContainer);
  }
};
// EXTERNAL MODULE: ./src/scripts/lazyload.js
var lazyload = __webpack_require__(4);
...
var main_$ = __webpack_require__(8);
...
main_$(function () {
  ...
  })([scripts, mobile, search, animate_default.a, post, lazyload_default.a, scripts_hover, scripts_gallery]);
});
